...
This program runs both TunnelKMeansTF and KMeans from scikit-learn on a sequence of
...
for n in [30000,100000,300000, 1000000,3000000,10000000]:
    ...
    for d in [2]:
        ...
        #for k in range(10,20,10):
            ...
            res={}
            for cl in ["TunnelKMeansTF", "KMeans"]:
            #for cl in ["KMeansTF"]:
                print(cl, end=" ")
            ...
            if not "KMeans" in res:
                ...
                speedup=res["KMeans"]/res["TunnelKMeansTF"]
